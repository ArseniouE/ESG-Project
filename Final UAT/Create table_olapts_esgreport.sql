...
(
    ...
    inv_pty_rtg_envrnm_scor character(18) COLLATE pg_catalog."default",
    inv_pty_rtg_envrnm_zon character(5) COLLATE pg_catalog."default",
    inv_pty_rtg_scl_scor character(18) COLLATE pg_catalog."default",
    inv_pty_rtg_scl_zon character(5) COLLATE pg_catalog."default",
    inv_pty_rtg_gvrnc_scor character(18) COLLATE pg_catalog."default",
    inv_pty_rtg_gvrnc_zon character(5) COLLATE pg_catalog."default",
    inv_pty_rtg_esg_scor character(18) COLLATE pg_catalog."default",
